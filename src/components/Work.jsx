                    ...
                    <div className='space-y-12'>
                        {
                            workData.map((data,index)=>(
                                <div key={index} className='relative pl-12 before:absolute before:left-0 before:top-0 before:w-[2px] before:h-full before:bg-purple cursor-pointer hover:-translate-y-2 transition-all duration-300'>
