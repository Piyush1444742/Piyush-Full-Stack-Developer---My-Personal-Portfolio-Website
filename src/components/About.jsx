                ...
                className='md:w-1/2'>
                    ...
                    <div className='rounded-2xl p-8 '>
                        ...
                        <p className='text-gray-300 mb-6'>
                            My journey as a full-stack developer started with a passion for technology and problem-solving. Over the years, I have explored both frontend and backend development, transforming ideas into functional and user-friendly web applications.
                        </p>
